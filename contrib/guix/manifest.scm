...
(define* (make-lunify-cross-toolchain  target
                                       #:key
...
desirable for building Lunify release binaries."
...
(packages->manifest
 (append
  (list ;; The Basics
        ...
        python-minimal ; required to build lunify (cmake/CheckTrezor.cmake) and in android_ndk
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-gnu")
           (list
             ...
             (make-lunify-cross-toolchain target)))
