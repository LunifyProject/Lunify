# lunify Blockchain Stats

lunify Blockchain Stats utlity exports daily statistics for the lunify blockchain from creation through current state.

## Usage:

See also the utility's help option. `lunify-blockchain-stats --help`
...
- `lunify-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `lunify-blockchain-stats | save-to-database.sh`
